...
public class TexturedUI extends GameEntity{

	private Texture tex;
	public String name;
	
	public TexturedUI(Vector2f pos, Vector2f size, String name) {
		super(pos, size);
		this.size = size;
		this.name = name;
		initTex();
	...
	protected void initTex(){
		try {
			tex = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/UI/" + name + ".png"));
